...
class TimesheetsControllerTest < ActionController::TestCase
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post :create, timesheet: { day: @timesheet.day, project_id: @timesheet.project_id, user_id: @timesheet.user_id, worked_hours: @timesheet.worked_hours }
    end
  ...
  test "should update timesheet" do
    patch :update, id: @timesheet, timesheet: { day: @timesheet.day, project_id: @timesheet.project_id, user_id: @timesheet.user_id, worked_hours: @timesheet.worked_hours }
    assert_redirected_to timesheet_path(assigns(:timesheet))
  end
